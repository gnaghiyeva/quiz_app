        ...
        <div class="container px-6 py-24 mx-auto lg:py-32">
          <div class="lg:flex">
            <div class="lg:w-1/2">
              ...
              <h1 class="mt-4 text-2xl font-medium text-gray-800 capitalize lg:text-3xl dark:text-dark">
                login to your account
              </h1>
            </div>

            <div class="mt-8 lg:w-1/2 lg:mt-0">
              <form class="w-full lg:max-w-xl" onSubmit={formik.handleSubmit}>
                <div class="relative flex items-center">
                  ...
                  <input
                    type="text"
                    class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 light:bg-gray-900 light:text-gray-300 light:border-gray-600 focus:border-blue-400 light:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                ...
                <div class="mt-8 md:flex md:items-center">
                  ...
                  <Link to={'/register'}>
                    <a href={() => false} class="inline-block mt-4 text-center text-blue-500 md:mt-0 md:mx-6 hover:underline dark:text-blue-400">
          ...
          <div class="mt-8 md:mt-24 sm:flex sm:items-center">
            ...
            <div class="flex items-center mt-4 sm:mt-0 -mx-1.5 sm:w-1/2">
              <a class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href={() => false}>
